...
use adapters::spi::message::message_repository::MessageRepository;
...
use mongodb_db::mongodb_connection::MongodbConnection;

pub async fn server(listener: TcpListener, app_name: &str) -> Result<Server, std::io::Error> {
    ...
    let mongodb = MongodbConnection::new("mongodb://localhost:27017").await;
